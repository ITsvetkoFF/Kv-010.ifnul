...
class AddPersonPage(InternalPage):
    ...
    def contacts_tab(self):
        return self.driver.find_element(*self.PERSON_CONTACTS_TAB)

    @property
    def addresses_tab(self):
        return self.driver.find_element(*self.PERSON_ADDRESSES_TAB)

    @property
    def papers_tab(self):
        return self.driver.find_element(*self.PERSON_PAPERS_TAB)

    @property
    def enrollments_tab(self):
        return self.driver.find_element(*self.PERSON_ENROLLMENTS_TAB)
    ...
    def click_addresses_tab(self):
        self.addresses_tab.click()
        self.wait_until_page_generate()

    def click_papers_tab(self):
        self.papers_tab.click()
        self.wait_until_page_generate()

    def click_enrollments_tab(self):
        self.enrollments_tab.click()
        self.wait_until_page_generate()
