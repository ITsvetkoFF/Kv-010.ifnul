...
class AddPersonAddressesPage(AddPersonPage):
    ...
    ALL_REGISTRATION_PLACES_SELECT = (
        By.XPATH, "//a[@class='ui-select-choices-row-inner']//div[@class='ng-binding ng-scope']")
    ...
    def zip_code_field(self):
        return self.driver.find_element(*self.INDEX_INPUT)

    @property
    def street_field(self):
        return self.driver.find_element(*self.STREET_INPUT)

    @property
    def house_field(self):
        return self.driver.find_element(*self.HOUSE_INPUT)

    @property
    def apartment_field(self):
        return self.driver.find_element(*self.APARTMENT_INPUT)
    ...
    def set_zip_code(self, index):
        ...
        :return:
        """
        input_text_in_field(self.zip_code_field, str(index))

    def set_street(self, street):
        """
        Method sets the street
        :param street: String parameter.
        :return:
        """
        input_text_in_field(self.street_field, street)

    def set_house(self, house):
        """
        Method sets the house
        :param house: Integer parameter.
        :return:
        """
        input_text_in_field(self.house_field, str(house))

    def set_apartment(self, apartment):
        """
        Method sets the apartment
        :param apartment: Integer parameter.
        :return:
        """
        input_text_in_field(self.apartment_field, str(apartment))
    ...
    def check_is_reg_and_post_addresses_the_same(self, is_addresses_match):
        ...
        :return:
        """
        checkbox_set_state(self.chechbox_address_match, is_addresses_match)
