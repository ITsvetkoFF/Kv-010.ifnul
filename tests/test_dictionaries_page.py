...
class TestDictionariesPageFunctionality(object):

    def test_01(self):
        self.app.dictionaries_page.select_dictionary_by_name("Довідник типів часових періодів")
        time.sleep(2)
        self.app.dictionaries_page.select_dictionary_by_option_value(5)
        time.sleep(2)

    def test_02(self):
        self.app.dictionaries_page.select_dictionary_by_name("Довідник типів поступлень")
        time.sleep(2)
        self.app.dictionaries_page.select_dictionary_by_option_value(8)
        time.sleep(2)
